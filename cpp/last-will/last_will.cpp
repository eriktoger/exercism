...
namespace estate_executor
{
    ...
    int assemble_account_number(int secret)
    {
        ...
        return zhang::bank_number_part(secret) +
               khan::bank_number_part(secret) +
               garcia::bank_number_part(secret);
    }

    int assemble_code()
    {

        int blue_fragment = zhang::blue::code_fragment() +
                            khan::blue::code_fragment() +
                            garcia::blue::code_fragment();

        int red_fragment = zhang::red::code_fragment() +
